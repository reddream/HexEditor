...
#define QHEXEDIT_COMMONDSAPI Q_DECL_EXPORT
#elif QHEXEDIT_IMPORTS
#define QHEXEDIT_COMMONDSAPI Q_DECL_IMPORT
#else
#define QHEXEDIT_COMMONDSAPI
#endif

class QHEXEDIT_COMMONDSAPI UndoStack : public QUndoStack
{
    Q_OBJECT
